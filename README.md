...
**버전**: v3.1.4
**최종 업데이트**: 2026-04-27 (v3.1.4 — SKILL.md CLI 상대경로 -> 절대경로 수정)
...
- v3.1.1: SKILL.md 12개 + references 파일 내 하드코딩 경로 전체 수정 (skills/qmslide/ → skills/)
- v3.1.2: Windows CP949 인코딩 오류 수정 (em dash, 특수 이모지 -> ASCII 대체)
- v3.1.3: Windows 인코딩 완전 수정 (arrow U+2192, coding decl, PYTHONIOENCODING env, open() encoding, references em dash)
- v3.1.4: SKILL.md CLI bash 블록 상대경로(shared/scripts/) -> 절대경로($env:USERPROFILE\.claude\skills\shared\scripts\) 수정, Windows 하드코딩 경로 제거
...
#   https://github.com/stfelix/QM_SLIDE_TEMPLATE_2026/releases/download/v3.1.4/quad-miners-pptx-skill-v3.skill
```
...
> [!] **v1.x, v2.x, v3.0.0, v3.1.0에서 v3.1.4로 업그레이드하는 경우, 기존 폴더명이 다를 수 있습니다.**
