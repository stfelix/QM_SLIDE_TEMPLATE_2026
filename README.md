...
**버전**: v3.1.3
**최종 업데이트**: 2026-04-26 (v3.1.3 — Windows 인코딩 완전 수정: arrow, coding decl, open() encoding)
...
#   https://github.com/stfelix/QM_SLIDE_TEMPLATE_2026/releases/download/v3.1.3/quad-miners-pptx-skill-v3.skill
```
...
> [!] **v1.x, v2.x, v3.0.0, v3.1.0에서 v3.1.3으로 업그레이드하는 경우, 기존 폴더명이 다를 수 있습니다.**
